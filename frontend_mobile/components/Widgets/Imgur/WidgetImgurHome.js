...
export default class WidgetImgurHome extends React.Component
{
  constructor(props) {
    super(props);
    this.state = {
  ...
  getFav() {
    fetch(`http://${global.ip}:8080/api/imgur-home`, {
      method: 'POST',
      headers: {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={{color:'white', textAlign: 'center'}}>get pics of the day</Text>
